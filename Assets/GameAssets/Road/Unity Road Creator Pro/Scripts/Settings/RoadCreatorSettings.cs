...
namespace RoadCreatorPro
{
    ...
    {
        // General
        public enum SceneViewMenu { None, Creation, Selection, Both }
        public SceneViewMenu sceneViewMenu = SceneViewMenu.Both;
        public bool showSceneViewMenuForAllObjects = false;
        public float anchorPointSize = 1.5f;
        public float controlPointSize = 1.5f;
        public float intersectionCurvePointSize = 0.3f;
