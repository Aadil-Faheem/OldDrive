...
{
    public class RoadObjectCreationButtons : MonoBehaviour
    {
        // Shortcut: CTRL + ALT + R
        [MenuItem("GameObject/3D Object/Road (CTRL + ALT + R) %&r", false, -10)]
        public static void CreateRoad(MenuCommand menuCommand)
        {
        ...
        public static void ConvertToSingleMesh(MenuCommand menuCommand)
        {
